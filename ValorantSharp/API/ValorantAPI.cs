...
namespace ValorantSharp.API
{
	public class ValorantAPI
	{
		...
		internal async Task<string> GetPlayerIdAsync()
		{
		...
		*/
		...
		public async Task<ValorantResult> FetchAccountXPAsync()
		{
		...
		public async Task<ValorantResult> FetchPlayerMMRAsync()
		{
		...
		public async Task<ValorantResult> FetchMatchHistoryAsync(int startIndex, int endIndex, string queue = null)
		{
		...
		public async Task<ValorantResult> FetchCompetitiveUpdatesAsync(int startIndex, int endIndex, string queue = null)
		{
		...
		/*
		 Party
		*/
		public async Task<ValorantResult> FetchPartyIdAsync()
		{
			var result = await _client.ExecuteAsync(new RestRequest($"{GLZBaseURL}/parties/v1/players/{_playerId}", Method.GET));
			if (!result.IsSuccessful)
				return new ValorantResult() { Error = result.ErrorException.Message, isSuccessful = false };
			return new ValorantResult() { isSuccessful = true, Data = result.Content };
		}
		...
		*/
		...
		{
			var result = await _client.ExecuteAsync(new RestRequest($"{GLZBaseURL}/pregame/v1/players/{_playerId}", Method.GET));
			if (!result.IsSuccessful)
				return new ValorantResult() { Error = result.ErrorException.Message, isSuccessful = false };
			return new ValorantResult() { isSuccessful = true, Data = result.Content };
		}
		...
		*/
		...
		{
			var result = await _client.ExecuteAsync(new RestRequest($"{PDBaseURL}/store/v2/storefront/{_playerId}", Method.GET));
			if (!result.IsSuccessful)
				return new ValorantResult() { Error = result.ErrorException.Message, isSuccessful = false };
			return new ValorantResult() { isSuccessful = true, Data = result.Content };
		}
		...
		{
			var result = await _client.ExecuteAsync(new RestRequest($"{PDBaseURL}/store/v1/wallet/{_playerId}", Method.GET));
			if (!result.IsSuccessful)
				return new ValorantResult() { Error = result.ErrorException.Message, isSuccessful = false };
			return new ValorantResult() { isSuccessful = true, Data = result.Content };
		}
		...
		{
			var result = await _client.ExecuteAsync(new RestRequest($"{PDBaseURL}/store/v1/entitlements/{_playerId}", Method.GET));
			if (!result.IsSuccessful)
				return new ValorantResult() { Error = result.ErrorException.Message, isSuccessful = false };
			return new ValorantResult() { isSuccessful = true, Data = result.Content };
		}
